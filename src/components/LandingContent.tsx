...
export function LandingContent() {
  return (
    <main className="bg-background min-h-screen overflow-x-hidden font-[family-name:var(--font-pretendard)] text-white">
      <section className="relative mx-auto flex w-full max-w-[1920px] flex-col items-center overflow-hidden lg:h-[940px] lg:flex-row lg:gap-[100px]">
        <div className="z-10 flex w-full flex-col justify-center px-6 py-16 md:px-12 lg:h-full lg:w-[842px] lg:py-0 lg:pl-[240px]">
          <div className="space-y-6 text-center md:space-y-8 md:text-left">
            <div className="space-y-2 md:space-y-4">
              <p className="text-3xl leading-tight font-bold md:text-5xl lg:text-[60px]">
                더 새로워진 일정 관리
              </p>

              <h1 className="text-brand-500 text-5xl font-extrabold tracking-tight md:text-6xl lg:text-[90px]">
                TASKIFY
              </h1>
            </div>

            <div className="flex flex-col gap-3 sm:flex-row sm:justify-center md:justify-start">
              <button className="rounded-full bg-zinc-700 px-10 py-4 text-sm font-semibold transition-colors hover:bg-zinc-600 md:text-base">
                회원가입하기
              </button>

              <button className="bg-brand-500 hover:bg-brand-400 rounded-full px-10 py-4 text-sm font-semibold text-black transition-colors md:text-base">
                로그인하기
              </button>
            </div>
          </div>
        ...
        <div className="relative flex w-full justify-center lg:min-w-0 lg:flex-1 lg:justify-start">
          <div
            className="relative h-[682px] w-[1212px] border border-zinc-800 bg-[#17171C] shadow-2xl"
            style={{
